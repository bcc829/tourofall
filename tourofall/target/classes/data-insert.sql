...
INSERT INTO comments(title,content,score,user_id,item_id) VALUES('경복궁 재미 없어요','집에 가고 싶어요',1.5,1,126508);
INSERT INTO comments(title,content,score,user_id,item_id) VALUES('마쟁이들 천국입니다','돈 다일어요',1,2,131257);
INSERT INTO comments(title,content,score,user_id,item_id) VALUES('Good Man','i like the horse',4,3,131257);