			...
			<div class="masthead-text-wrapper">
				<div class="masthead-text masthead-responsive-mask">
					...
					<div class="masthead-straplines">
						<div id="ms1" class="masthead-strapline">
							<a href="#" class="masthead-subtitle">내장산국립공원</a>
							<div class="dest-content">
								전북 정읍시 내장동, 전남 장성군 북하면 백양로<br/>
							</div>
						</div>
						<div id="ms2" class="masthead-strapline">							
								<a href="#" class="masthead-subtitle">강릉 심상진가옥</a>
								<div class="dest-content">
									강원도 강릉시 운정길 125(운정동)<br/>
								</div>
						</div>
						<div id="ms3" class="masthead-strapline">					
							<a href="#" class="masthead-subtitle">경복궁</a>
							<div class="dest-content">
								서울특별시 종로구 사직로 161(세종로)<br/>
